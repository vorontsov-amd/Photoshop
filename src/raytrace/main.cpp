...
int main() {
    ...
    sf::RenderWindow window(sf::VideoMode(image_width, image_height), "RayCasting");
    ...
    sf::Texture tx;
    tx.create(image_width, image_height);
    tx.update((sf::Uint8*)img, image_width, image_height, 0, 0);
    sf::Sprite sp;
    sp.setTexture(tx);
    window.draw(sp);
